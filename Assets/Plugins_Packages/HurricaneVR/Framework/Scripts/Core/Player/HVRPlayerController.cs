...
namespace HurricaneVR.Framework.Core.Player
{
    public class HVRPlayerController : MonoBehaviour
    {
        ...
        public HVRbool3 ClimbingAxis => LeftHand ? LeftHand.ClimbingAxis : RightHand.ClimbingAxis;
        ...
        protected virtual void HandleClimbing()
        {
            ...
            var move = (left + right);
            move = new Vector3(ClimbingAxis.x ? move.x : 0, ClimbingAxis.y ? move.y : 0, ClimbingAxis.z ? move.z : 0);
