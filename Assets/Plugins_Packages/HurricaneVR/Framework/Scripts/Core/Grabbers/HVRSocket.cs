...
namespace HurricaneVR.Framework.Core.Grabbers
{
    public class HVRSocket : HVRGrabberBase
    {
        ...
        public bool SockFromHover { get => GrabsFromHand; set => GrabsFromHand = value; }
        ...
        public bool CanRemoveGrabbableFromHover { get => CanRemoveGrabbable; set => CanRemoveGrabbable = value; }
        ...
        public VRGrabberEvent TrySocket = new VRGrabberEvent();
        ...
        public virtual bool TryGrab(HVRGrabbable grabbable, bool force = false, bool ignoreGrabSound = false)
        {
            try
            {
                TrySocket?.Invoke(this, grabbable);
