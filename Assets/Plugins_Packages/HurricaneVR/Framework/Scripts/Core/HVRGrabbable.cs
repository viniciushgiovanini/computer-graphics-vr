...
namespace HurricaneVR.Framework.Core
{
    public class HVRGrabbable : MonoBehaviour
    {
        ...
        [Tooltip("By default the grabbable will be grabbed by both hands, set this to only allow one hand to grab.")]
        public HandGrabType HandGrabType = HandGrabType.Both;
        ...
        public HVRHandGrabber HandGrabber => IsLeftHandGrabbed ? LeftHandGrabber : RightHandGrabber;
